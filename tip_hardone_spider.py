...
qual_level_lo = fuzz.interp_membership(x_qual, qual_lo, a)
qual_level_md = fuzz.interp_membership(x_qual, qual_md, a)
qual_level_hi = fuzz.interp_membership(x_qual, qual_hi, a)
